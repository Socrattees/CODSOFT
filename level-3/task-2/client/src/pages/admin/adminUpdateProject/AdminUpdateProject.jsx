...
const AdminUpdateProject = () => {
  ...
  return (
    <>
      <AdminNavbar />
      <div className="admin-update-project">
        <div className="admin-update-project-container">
          <div className="admin-update-project-form-wrapper">
            <h2>Update Project</h2>
            <form onSubmit={handleSubmit} className="admin-update-project-form">
